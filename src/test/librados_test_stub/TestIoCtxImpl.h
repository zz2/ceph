...
public:
  ...
  virtual int aio_operate(const std::string& oid, ObjectOperations &ops,
                          AioCompletionImpl *c, SnapContext *snap_context,
                          int flags);
  virtual int aio_operate_read(const std::string& oid, ObjectOperations &ops,
  ...
  virtual int operate(const std::string& oid, ObjectOperations &ops);
  virtual int operate_read(const std::string& oid, ObjectOperations &ops,
                           bufferlist *pbl);
...
protected:
  ...
  int execute_aio_operations(const std::string& oid, ObjectOperations &ops,
                             bufferlist *pbl);
