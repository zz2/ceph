...
int IoCtx::aio_operate(const std::string& oid, AioCompletion *c,
                       ...
                       bufferlist *pbl) {
  TestIoCtxImpl *ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  ObjectOperations *ops = reinterpret_cast<ObjectOperations*>(op->impl);
...
int IoCtx::notify(const std::string& o, bufferlist& bl,
...
int IoCtx::unwatch(uint64_t handle) {
  TestIoCtxImpl *ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int IoCtx::watch(const std::string& o, uint64_t *handle,
...
ObjectOperation::ObjectOperation() {
  impl = reinterpret_cast<ObjectOperationImpl*>(new ObjectOperations());
}

ObjectOperation::~ObjectOperation() {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  if (o) {
    delete o;
    o = NULL;
  }
...
void ObjectOperation::assert_exists() {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::assert_exists, _1, _2));
}

void ObjectOperation::exec(const char *cls, const char *method,
                           bufferlist& inbl) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::exec, _1, _2,
...
void ObjectWriteOperation::create(bool exclusive) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::create, _1, _2, exclusive));
}

void ObjectWriteOperation::omap_set(const std::map<std::string, bufferlist> &map) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::omap_set, _1, _2,
                           boost::ref(map)));
}

void ObjectWriteOperation::remove() {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::remove, _1, _2));
}

void ObjectWriteOperation::selfmanaged_snap_rollback(uint64_t snapid) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::selfmanaged_snap_rollback,
                           _1, _2, snapid));
}
...
void ObjectWriteOperation::set_alloc_hint(uint64_t expected_object_size,
  ...
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::set_alloc_hint, _1, _2,
                           expected_object_size, expected_write_size));
}

void ObjectWriteOperation::truncate(uint64_t off) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::truncate, _1, _2, off));
}

void ObjectWriteOperation::write(uint64_t off, const bufferlist& bl) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::write, _1, _2, bl, bl.length(),
                           off));
}

void ObjectWriteOperation::write_full(const bufferlist& bl) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::write_full, _1, _2, bl));
}

void ObjectWriteOperation::zero(uint64_t off, uint64_t len) {
  ObjectOperations *o = reinterpret_cast<ObjectOperations*>(impl);
  o->push_back(boost::bind(&TestIoCtxImpl::zero, _1, _2, off, len));
}
